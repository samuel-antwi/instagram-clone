...
const FeedPostSkeleton = () => {
  return (
    <PostSkeletonStyles className='container'>
      <div className='header-skeleton'>
        <div className='avatar-skeleton' />
        <div className='header-text-skeleton'>
          <div className='primary-text-skeleton' />
...
const PostSkeletonStyles = styled.div`
  .conatainer {
    display: flex;
    ...
    position: relative;
    width: 100%;
    border-radius: 3px, border 1px solid rgba(var(--b6a, 219, 219, 219), 1);
  ...
  .avatar-skeleton {
    background: rgba(var(--c90, 239, 239, 239), 1);
    border-radius: 50%;
    flex-grow: 0;
    height: 30px;
    margin-right: 12;
